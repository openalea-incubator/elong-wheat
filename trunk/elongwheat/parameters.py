...
Ksslw = 4160  #: Affinite SSLW aux fructanes (Âµmol C g-1)
min_SSLW = 22 #: g m-2
max_SSLW = 50 #: g m-2
...
class HiddenZoneInit(object):
    ...
    def __init__(self):
        ...
        self.internode_distance_to_emergence = 0        #: m
        self.delta_internode_distance_to_emergence = 0  #: m, needded for growthwheat
        ...
        self.internode_pseudo_age = None
