...
if __name__ == '__main__':
    ...
    inputs = elongwheat_converter.from_dataframes(hiddenzone_inputs_df, organ_inputs_df)
    # initialize the simulation with the inputs
    simulation_.initialize(inputs)
    # run the simulation
    simulation_.run()
    # convert the outputs to Pandas dataframe
    hiddenzone_outputs_df, organ_outputs_df = elongwheat_converter.to_dataframes(simulation_.outputs)
